        ...
        <div>
            <div className="d-flex align-items-center justify-content-between mb-4">
                ...
                <button
                    ...
                    onClick={openCreate}
                >
                    <i className="bi bi-plus-lg"></i> Nueva orden
                </button>
            </div>
            ...
            <div className="row g-2 mb-3">
                {ALL_STATUSES.map((s) => (
                    <div className="col" key={s}>
                        <div
                            className={`card border-0 text-center py-2 px-1 shadow-sm ${filterStatus === s ? `border border-${STATUS_COLORS[s]}` : ""}`}
                ...
                <div className="card-body p-0">
                    {loading ? (
                        ...
                        <div className="text-center py-5 text-muted">
                            ...
                            hay órdenes
                            {filterStatus !== "ALL"
                                ? ` con estado "${STATUS_LABELS[filterStatus as OrderStatus]}"`
                                : ""}
                        </div>
                    ) : (
